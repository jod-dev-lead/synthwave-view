...
const features = [
  {
    ...
    description:
      "Create stunning charts and graphs with real-time data visualization capabilities.",
    icon: BarChart3,
    image: chartsFeature,
  },
  {
    ...
    description:
      "Get insights and answers from your data using our advanced AI chat interface.",
    icon: MessageSquare,
    image: aiChatFeature,
  },
  {
    ...
    description:
      "Built for speed with optimized queries and real-time updates across all devices.",
    icon: Zap,
  },
  {
  ...
  },
  {
    ...
    description:
      "Deep insights with predictive analytics and machine learning capabilities.",
    icon: TrendingUp,
  },
];
